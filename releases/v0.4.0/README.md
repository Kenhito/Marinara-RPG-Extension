# Marinara-RPG-Extension v0.4.0 — Game Mode
...
This is **v0.4.0** of the Game Mode framework. The bundle envelope's `minExtensionVersion` is 0.4.0 — older framework JS won't accept this bundle's features (typed damage, sorcery category, build-agents separation). Always update the framework JS first, then the bundle, then the agents.
